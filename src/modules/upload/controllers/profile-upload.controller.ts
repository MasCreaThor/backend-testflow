...
import { FindPeopleByIdService } from '../../people/services/find-people-by-id.service';
import { UpdatePeopleService } from '../../people/services/update-people.service';
...
export class ProfileUploadController {
  ...
  async uploadProfileImage(
    ...
    try {
      ...
      const person = await this.findPeopleByIdService.execute(peopleId);
      if (!person) {
      ...
      await this.updatePeopleService.execute(peopleId, {
